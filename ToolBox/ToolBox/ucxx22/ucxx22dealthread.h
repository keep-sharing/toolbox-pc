#ifndef UCXX22DEALTHREAD_H
#define UCXX22DEALTHREAD_H

#include <QObject>
#include <QThread>
#include <QVariant>
#include "ucxx22/unp/qunpucxx22.h"

class UCXX22DealThread : public QObject
{
    Q_OBJECT
public:
    ...
    explicit UCXX22DealThread(QObject *parent = nullptr);
    ~UCXX22DealThread();
...
signals:
    ...
    void getDeviceStatus(UCXX22DealThread::StructPageStatus info);
    void getGeneral(UCXX22DealThread::StructPageGeneral info);
    void getSetting(UCXX22DealThread::StructPageSetting info);
