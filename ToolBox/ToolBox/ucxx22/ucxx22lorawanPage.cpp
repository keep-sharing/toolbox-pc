 ...
 * @param index
 */
void UCXX22Model::on_tabWidget_2_tabBarClicked(int index)
{
    QVariantMap map;
    if(index == LG_BASIC){
    ...
    QVariantList list;
    list.append(map);
    emit requestToDevice(UCXX22DealThread::PAGE_LORAWAN,list);

}

/**
 * 接收Lorewan页面返回数据
 * @brief UCXX22Model::onRecvLorawan
 * @param info
 */
void UCXX22Model::onRecvLorawan(StructPageLorawan info)
{
...
/**
 * 保存lora basic页面数据
 * @brief UCXX22Model::on_generalBasicSave_btn_clicked
 */
bool UCXX22Model::on_generalBasicSave_btn_clicked()
{
    ...
    emit requestToDevice(UCXX22DealThread::CONFIG_WRITE_LORAWAN,list);
    map.insert("devEui","**********");
    map.insert("appKey","**********");
    map.insert("devAddr","**********");
 ...
 */
bool UCXX22Model::on_generalJTNSave_btn_clicked()
{
    QList<QLineEdit*> le;
    bool ok=true;
...
void UCXX22Model::setLoraChannelData(StructPageLorawan info)
{
    //channel
    QList<QCheckBox*> cb;
...
void UCXX22Model::setLoraChannelFixFre(QVariantMap map,bool lastVis)
{
...
void UCXX22Model::on_joinType_cbx_currentIndexChanged(int index)
{
...
bool UCXX22Model::on_generalChannelSave_btn_clicked()
{
    QList<QCheckBox*> cb;
    cb<<ui->channel0_cb<<ui->channel1_cb<<ui->channel2_cb<<ui->channel3_cb<<ui->channel4_cb<<ui->channel5_cb<<ui->channel6_cb<<ui->channel7_cb;
...
bool UCXX22Model::on_fixedFreSave_btn_clicked()
{
...
void UCXX22Model::on_supportFre2_cbx_currentIndexChanged(const QString &arg1)
{
    on_supportFre_cbx_currentIndexChanged(arg1);
    ui->supportFre_cbx->setCurrentIndex(ui->supportFre_cbx->findText(arg1));
}

void UCXX22Model::on_supportFre_cbx_currentIndexChanged(const QString &arg1)
{
...
void UCXX22Model::onCheckChannelAllClicked()
{
    QList<QCheckBox*> cb;
    cb<<ui->channel0_cb<<ui->channel1_cb<<ui->channel2_cb<<ui->channel3_cb<<ui->channel4_cb<<ui->channel5_cb<<ui->channel6_cb<<ui->channel7_cb;
...
void UCXX22Model::on_channelAll_cb_clicked(bool checked)
{
    QList<QCheckBox*> cb;
    cb<<ui->channel0_cb<<ui->channel1_cb<<ui->channel2_cb<<ui->channel3_cb<<ui->channel4_cb<<ui->channel5_cb<<ui->channel6_cb<<ui->channel7_cb;
