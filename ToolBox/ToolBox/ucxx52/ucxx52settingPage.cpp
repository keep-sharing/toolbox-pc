...
void UCXX52Model::on_settingEditSave_btn_clicked()
{
    ...
    if((ui->if_cbx->currentData().toInt() != IC_Empty) && (ui->then1_cbx->currentIndex() != TC_Empty)){
        ...
        if(ui->if_cbx->currentData().toInt() == IC_Time){
            ...
            if(ui->analogStatus_cbx->currentIndex() != QunpUCXX52::UNXX_AI_WITHIN){
                ...
                ifConfig = tr("the value of the ")+ ifConfig + ui->analogStatus_cbx->itemText(ifmap.value("analogStatus").toInt())+" "+
                        ui->withMa1_lineedit->text().trimmed() + tr(" to ")+ui->withMa2_lineedit->text().trimmed()+" ";
            }
            ...
            ifConfig = ifConfig + tr(" for longer than %2%3")
    ...
    qDebug()<<ui->modbusStatus_cbx->currentData()<<ifmap.value("modbusStatus").toInt()<<ifmap.value("modbusChannelStatus").toInt();
            if(ui->modbusStatus_cbx->currentData() == QunpUCXX52::UNXX_MB_WITHIN){
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->currentText() +tr(" is between ")+
                ...
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->currentText() +tr(" is false  ");
            }else if(ui->modbusStatus_cbx->currentData() == QunpUCXX52::UNXX_MB_TRUE){
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->currentText() +tr(" is true ");
            }else if(ui->modbusStatus_cbx->currentData() == QunpUCXX52::UNXX_MB_ABOVE){
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->currentText() +tr(" is above ")+
                        ui->modbusAboveMa_lineedit->text().trimmed();
            }else if(ui->modbusStatus_cbx->currentData() == QunpUCXX52::UNXX_MB_BELOW){
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->currentText() +tr(" is below ")+
                        ui->modbusAboveMa_lineedit->text().trimmed();
            }
            ...
            ifConfig = ifConfig + tr(" continuing for %2%3")
            ...
            if( ui->continuedSec_lineedit->isVisible() && (ui->continuedSec_lineedit->text().toInt()!=0) ){
                ...
                ifConfig = ifConfig + tr("and remaining %1 for longer then %2%3")
                        .arg(ui->inputLevel_cbx->currentData().toInt() == INC_GoseActive?tr("active"):tr("inactive"))
...
//        then1map.insert("durationUnit",ui->durationSec1_cbx->currentIndex());
        ...
        case TC_Output1:
            ...
            then1Config = then1Config + ui->level1_cbx->currentData().toString()+
                    ...
                    ((ui->delayTimeSec1_lineedit->isVisible()    && (ui->delayTimeSec1_lineedit->text().toFloat()    !=0)) ? (tr(" in ")+ui->delayTimeSec1_lineedit->text().trimmed()+ui->delayTimeSec1_cbx->currentText()+" "):"")+
                    ((ui->durationSec1_lineedit->isVisible()     && (ui->durationSec1_lineedit->text().toFloat()     !=0)) ? (tr("and it will last for ")+ui->durationSec1_lineedit->text().trimmed()+ui->durationSec1_cbx->currentText()+" "):" ")+
                    ((ui->highLevelSec1_lineedit->isVisible()    && (ui->highLevelSec1_lineedit->text().toFloat()    !=0)) ? (tr("with activate ")+ui->highLevelSec1_lineedit->text().trimmed()+ui->highLevelSec1_cbx->currentText()+" "):" ")+
                    ((ui->lowLevelSec1_lineedit->isVisible()     && (ui->lowLevelSec1_lineedit->text().toFloat()     !=0)) ? (tr("and de-activate ")+ui->lowLevelSec1_lineedit->text().trimmed()+ui->lowLevelSec1_cbx->currentText()+" "):" ");
        ...
        configuration = tr("If %1,\nthen %2").arg(ifConfig.trimmed()).arg(then1Config.trimmed());
        then2map.insert("index",ui->then2_cbx->currentData().toInt());
        if(ui->then2_cbx->currentData().toInt() != TC_Empty){
            QString then2Config ;
            if(ui->then2_cbx->currentData().toInt() == TC_StatusMessage || ui->then2_cbx->currentData().toInt() == TC_CustomMessage){
                then2Config = tr("And ")+ui->then2_cbx->currentText().trimmed()+" ";
            }else{
                then2Config = tr("And ")+ui->then2_cbx->currentText().trimmed()+" ";
            }
...
//            then2map.insert("durationUnit",ui->durationSec2_cbx->currentIndex());
            ...
            case TC_Output1:
                then2Config = then2Config + ui->level2_cbx->currentData().toString()+
                        ...
                        ((ui->delayTimeSec2_lineedit->isVisible()    && (ui->delayTimeSec2_lineedit->text().toFloat()    !=0)) ? (tr(" in ")+ui->delayTimeSec2_lineedit->text().trimmed()+ui->delayTimeSec2_cbx->currentText()+" "):" ")+
                        ((ui->durationSec2_lineedit->isVisible()     && (ui->durationSec2_lineedit->text().toFloat()     !=0)) ? (tr("and it will last for ")+ui->durationSec2_lineedit->text().trimmed()+ui->durationSec2_cbx->currentText()+" "):" ")+
                        ((ui->highLevelSec2_lineedit->isVisible()    && (ui->highLevelSec2_lineedit->text().toFloat()    !=0)) ? (tr("with activate ")+ui->highLevelSec2_lineedit->text().trimmed()+ui->highLevelSec2_cbx->currentText()+" "):" ")+
                        ((ui->lowLevelSec2_lineedit->isVisible()     && (ui->lowLevelSec2_lineedit->text().toFloat()     !=0)) ? (tr("and de-activate ")+ui->lowLevelSec2_lineedit->text().trimmed()+ui->lowLevelSec2_cbx->currentText()+" "):" ");
        ...
        if(ui->then3_cbx->currentData().toInt() != TC_Empty){
            QString then3Config ;
            if(ui->then3_cbx->currentData().toInt() == TC_StatusMessage || ui->then2_cbx->currentData().toInt() == TC_CustomMessage){
                then3Config = tr("And ")+ui->then3_cbx->currentText().trimmed()+" ";
            }else{
...
//            then3map.insert("durationUnit",ui->durationSec3_cbx->currentIndex());
            ...
            case TC_Output1:
                then3Config = then3Config + ui->level3_cbx->currentData().toString()+
                        ...
                        ((ui->delayTimeSec3_lineedit->isVisible()    && (ui->delayTimeSec3_lineedit->text().toFloat()    !=0)) ? (tr(" in ")+ui->delayTimeSec3_lineedit->text().trimmed()+ui->delayTimeSec3_cbx->currentText()+" "):"")+
                        ((ui->durationSec3_lineedit->isVisible()     && (ui->durationSec3_lineedit->text().toFloat()     !=0)) ? (tr("and it will last for ")+ui->durationSec3_lineedit->text().trimmed()+ui->durationSec3_cbx->currentText()+" "):" ")+
                        ((ui->highLevelSec3_lineedit->isVisible()    && (ui->highLevelSec3_lineedit->text().toFloat()    !=0)) ? (tr("with activate ")+ui->highLevelSec3_lineedit->text().trimmed()+ui->highLevelSec3_cbx->currentText()+" "):" ")+
                        ((ui->lowLevelSec3_lineedit->isVisible()     && (ui->lowLevelSec3_lineedit->text().toFloat()     !=0)) ? (tr("and de-activate ")+ui->lowLevelSec3_lineedit->text().trimmed()+ui->lowLevelSec3_cbx->currentText()+" "):" ");
        ...
        if(ui->setLockouTime_cb->isChecked() && ui->setLockouTime_cb->isVisible()){
            ...
            configuration = QString("%1\n%2").arg(configuration)
                                             .arg(tr("And it will not allowed to trigger again until %1%2 has elapsed.").arg(ui->lockouttime_lineedit->text().trimmed()).arg(ui->setLockoutTime_cbx->currentText()));
            ...
            configuration = QString("%1\n%2").arg(configuration)
                                             .arg(tr("And it will not allowed to trigger again until %1%2 has elapsed.").arg(ui->lockouttimeAnalog_lineedit->text().trimmed()).arg(ui->setLockoutTimeAnalog_cbx->currentText()));
            ...
            configuration = QString("%1\n%2").arg(configuration)
                                             .arg(tr("And it will not allowed to trigger again until %1%2 has elapsed.").arg(ui->lockouttimeMudbus_lineedit->text().trimmed()).arg(ui->setLockoutTimeMudbus_cbx->currentText()));
        }else{
    ...
    for(int row=0; row<command_list.size(); row++){
        ...
        if(ifmap.value("index").toInt() == IC_Time){
            ...
            if(ifmap.value("analogStatus").toInt() == QunpUCXX52::UNXX_AI_ABOVE){
                ...
                ifConfig = tr("the value of the ")+ ifConfig + ui->analogStatus_cbx->itemText(ifmap.value("analogStatus").toInt())+" "+
                        mAtoThreshold(ifmap.value("belowValue").toString(),ifmap.value("index").toInt()) + tr(" to ")+mAtoThreshold(ifmap.value("aboveValue").toString(),ifmap.value("index").toInt());
            ...
            if(ifmap.value("modbusStatus").toInt() == QunpUCXX52::UNXX_MB_WITHIN){
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->itemText(ui->modbusChannelStatus_cbx->findData(ifmap.value("modbusChannelStatus").toInt())) +tr(" is between ")+
                        (ifmap.value("belowValue").toString()) + tr(" and ")+(ifmap.value("aboveValue").toString());
            }else if(ifmap.value("modbusStatus").toInt() == QunpUCXX52::UNXX_MB_FALSE){
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->itemText(ui->modbusChannelStatus_cbx->findData(ifmap.value("modbusChannelStatus").toInt())) +tr(" is false  ");
            }else if(ifmap.value("modbusStatus").toInt() == QunpUCXX52::UNXX_MB_TRUE){
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->itemText(ui->modbusChannelStatus_cbx->findData(ifmap.value("modbusChannelStatus").toInt())) +tr(" is true ");
            }else if(ifmap.value("modbusStatus").toInt() == QunpUCXX52::UNXX_MB_ABOVE) {
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->itemText(ui->modbusChannelStatus_cbx->findData(ifmap.value("modbusChannelStatus").toInt())) +tr(" is above ")+
                        (ifmap.value("aboveValue").toString());
            }else if(ifmap.value("modbusStatus").toInt() == QunpUCXX52::UNXX_MB_BELOW) {
                ifConfig = tr("the value of ")+ ui->modbusChannelStatus_cbx->itemText(ui->modbusChannelStatus_cbx->findData(ifmap.value("modbusChannelStatus").toInt())) +tr(" is below ")+
            ...
            if(ifmap.value("continueForSec").toInt()!=Empty_Time){
                ifConfig = ifConfig + tr("and remaining %1 for longer than %2%3")
        ...
        case TC_Output1:{
            ...
            then1Config = then1Config + levelConfing+
                    ...
                    (then1map.value("delay").toInt()!=Empty_Time?(tr(" in ")+ascMsToSec(then1map.value("delay").toString(),outputtimemap.value("outputDelayUnit1").toInt())+ui->delayTimeSec1_cbx->itemText(outputtimemap.value("outputDelayUnit1").toInt())+" "):"")+
                    (then1map.value("duration").toInt()!=Empty_Time ? (tr("and it will last for ")+ascMsToSec(then1map.value("duration").toString(),outputtimemap.value("durationUnit1").toInt())+ui->durationSec1_cbx->itemText(outputtimemap.value("durationUnit1").toInt())+" "):"")+
                    (then1map.value("high").toInt()!=Empty_Time ? (tr("with activate ")+ascMsToSec(then1map.value("high").toString())+"s "):"")+
                    (then1map.value("low").toInt()!=Empty_Time ? (tr("and de-activate ")+ascMsToSec(then1map.value("low").toString())+"s "):"");
        }
            break;
        case TC_Output2:{
            QString levelConfing;
            ...
            then1Config = then1Config + levelConfing+
                    (then1map.value("durationWF").toInt()!=Empty_Time?(ascMsToSec(then1map.value("durationWF").toString())+"s "):"")+
                    (then1map.value("delay").toInt()!=Empty_Time?(tr(" in ")+ascMsToSec(then1map.value("delay").toString(),outputtimemap.value("outputDelayUnit2").toInt())+ui->delayTimeSec1_cbx->itemText(outputtimemap.value("outputDelayUnit2").toInt())+" "):"")+
                    (then1map.value("duration").toInt()!=Empty_Time ? (tr("and it will last for ")+ascMsToSec(then1map.value("duration").toString(),outputtimemap.value("durationUnit2").toInt())+ui->durationSec1_cbx->itemText(outputtimemap.value("durationUnit2").toInt())+" "):"")+
                    (then1map.value("high").toInt()!=Empty_Time?(tr("with activate ")+ascMsToSec(then1map.value("high").toString())+"s "):"")+
                    (then1map.value("low").toInt()!=Empty_Time?(tr("and de-activate ")+ascMsToSec(then1map.value("low").toString())+"s "):"");
        }
            break;
        ...
        if(then2map.value("index").toInt() != TC_Empty){
            ...
            case TC_Output1:{
                ...
                then2Config = then2Config + level2Confing+
                        ...
                        (then2map.value("delay").toInt()!=Empty_Time?(tr(" in ")+ascMsToSec(then2map.value("delay").toString(),outputtimemap.value("outputDelayUnit1").toInt())+ui->delayTimeSec2_cbx->itemText(outputtimemap.value("outputDelayUnit1").toInt())+" "):"")+
                        (then2map.value("duration").toInt()!=Empty_Time?(tr("and it will last for ")+ascMsToSec(then2map.value("duration").toString(),outputtimemap.value("durationUnit1").toInt())+ui->durationSec2_cbx->itemText(outputtimemap.value("durationUnit1").toInt())+" "):"")+
                        (then2map.value("high").toInt()!=Empty_Time?(tr("with activate ")+ascMsToSec(then2map.value("high").toString())+"s "):"")+
                        (then2map.value("low").toInt()!=Empty_Time?(tr("and de-activate ")+ascMsToSec(then2map.value("low").toString())+"s "):"");
            }
                break;
            case TC_Output2:{
                QString level2Confing;
                ...
                then2Config = then2Config + level2Confing+
                        (then2map.value("durationWF").toInt()!=Empty_Time?(ascMsToSec(then2map.value("durationWF").toString())+"s "):"")+
                        (then2map.value("delay").toInt()!=Empty_Time?(tr(" in ")+ascMsToSec(then2map.value("delay").toString(),outputtimemap.value("outputDelayUnit2").toInt())+ui->delayTimeSec2_cbx->itemText(outputtimemap.value("outputDelayUnit2").toInt())+" "):"")+
                        (then2map.value("duration").toInt()!=Empty_Time?(tr("and it will last for ")+ascMsToSec(then2map.value("duration").toString(),outputtimemap.value("durationUnit2").toInt())+ui->durationSec2_cbx->itemText(outputtimemap.value("durationUnit2").toInt())+" "):"")+
                        (then2map.value("high").toInt()!=Empty_Time?(tr("with activate ")+ascMsToSec(then2map.value("high").toString())+"s "):"")+
                        (then2map.value("low").toInt()!=Empty_Time?(tr("and de-activate ")+ascMsToSec(then2map.value("low").toString())+"s "):"");
            }
                break;
        ...
        if(then3map.value("index").toInt() != TC_Empty){
            ...
            case TC_Output1:{
                ...
                then3Config = then3Config + level3Confing+
                        ...
                        (then3map.value("delay").toInt()!=Empty_Time?(tr(" in ")+ascMsToSec(then3map.value("delay").toString(),outputtimemap.value("outputDelayUnit1").toInt())+ui->delayTimeSec3_cbx->itemText(outputtimemap.value("outputDelayUnit1").toInt())+" "):"")+
                        (then3map.value("duration").toInt()!=Empty_Time?(tr("and it will last for ")+ascMsToSec(then3map.value("duration").toString(),outputtimemap.value("durationUnit1").toInt())+ui->durationSec3_cbx->itemText(outputtimemap.value("durationUnit1").toInt())+" "):"")+
                        (then3map.value("high").toInt()!=Empty_Time?(tr("with activate ")+ascMsToSec(then3map.value("high").toString())+"s "):"")+
                        (then3map.value("low").toInt()!=Empty_Time?(tr("and de-activate ")+ascMsToSec(then3map.value("low").toString())+"s "):"");
            }
                break;
            case TC_Output2:{
                QString level3Confing;
                ...
                then3Config = then3Config + level3Confing+
                        (then3map.value("durationWF").toInt()!=Empty_Time?(ascMsToSec(then3map.value("durationWF").toString())+"s "):"")+
                        (then3map.value("delay").toInt()!=Empty_Time?(tr(" in ")+ascMsToSec(then3map.value("delay").toString(),outputtimemap.value("outputDelayUnit2").toInt())+ui->delayTimeSec3_cbx->itemText(outputtimemap.value("outputDelayUnit2").toInt())+" "):"")+
                        (then3map.value("duration").toInt()!=Empty_Time?(tr("and it will last for ")+ascMsToSec(then3map.value("duration").toString(),outputtimemap.value("durationUnit2").toInt())+ui->durationSec3_cbx->itemText(outputtimemap.value("durationUnit2").toInt())+" "):"")+
                        (then3map.value("high").toInt()!=Empty_Time?(tr("with activate ")+ascMsToSec(then3map.value("high").toString())+"s "):"")+
                        (then3map.value("low").toInt()!=Empty_Time?(tr("and de-activate ")+ascMsToSec(then3map.value("low").toString())+"s "):"");
            }
                break;
        ...
        if(ifmap.value("continueForSecAnalog").toInt()!=Empty_Time){
            if(ifmap.value("setLockTime").toInt() != Empty_Time){
                configuration = QString("%1\n%2").arg(configuration)
                                                 .arg(tr("And it will not allowed to trigger again until %1%2 has elapsed.")
