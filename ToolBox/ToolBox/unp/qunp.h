...
//    #endif
    ...
    typedef struct uc11t1_status_e {
        uint8_t battery;
        uint8_t joinstate;
        int8_t snr;
        int16_t rssi;
    ...
    /* AM102、AM100\EM500-CO2：temperature\humi\pir\als\co2\dpr\tvoc
    ...
    */
    ...
    explicit Qunp(QObject *parent = nullptr);
    ...
    unp_state_t unp_get_product_name(uint8_t *name);
    unp_state_t unp_get_product_pn(uint8_t *pn);
...
private:
    ...
    user_config_t_am    *pUserConfig_am;
    ...
    uc11t1_status_t      g_uc11t1_status;
