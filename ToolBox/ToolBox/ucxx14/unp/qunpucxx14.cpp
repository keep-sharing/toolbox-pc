#include "qunpucxx14.h"

QunpUCXX14::QunpUCXX14(QObject *parent) : QObject(parent)
{
...
void QunpUCXX14::deal_upgrade_uboot(uint8_t *data, uint16_t datasize)
{
...
void QunpUCXX14::deal_upgrade_uboot_ack(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(data)
    Q_UNUSED(datasize)
...
void QunpUCXX14::deal_reset_dev(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(data)
    Q_UNUSED(datasize)
    uint8_t pkt[32] = {0};
...
void QunpUCXX14::deal_reset_dev_ack(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(data)
    Q_UNUSED(datasize)
...
void QunpUCXX14::deal_dtu_status(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(data)
    Q_UNUSED(datasize)
}

void QunpUCXX14::deal_lorawan_reload_ack(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(data)
    Q_UNUSED(datasize)
...
void QunpUCXX14::deal_connect_dev(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(datasize)
    Q_UNUSED(data)
    uint8_t pkt[32] = {0};
...
void QunpUCXX14::deal_connect_dev_ack(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(data)
    Q_UNUSED(datasize)
...
void QunpUCXX14::deal_reload_config_dev_ack(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(datasize)
    Q_UNUSED(data)
    g_unp_ack.type = DEVICE_RELOAD_CONFIG_ACK_PKT;
...
void QunpUCXX14::deal_reload_config_dev(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(data)
    Q_UNUSED(datasize)
    g_unp_ack.type = DEVICE_RELOAD_CONFIG_ACK_PKT;
...
void QunpUCXX14::deal_passwd_input(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(data)
    Q_UNUSED(datasize)
    uint8_t pkt[32] = {0};
...
void QunpUCXX14::deal_passwd_input_ack(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(datasize)
...
void QunpUCXX14::deal_reboot(void)
{
    uint8_t pkt[32] = {0};
    uint16_t pktlen;
...
void QunpUCXX14::deal_reboot_ack(void)
{
...
void QunpUCXX14::deal_upgrade(uint8_t *buffer, uint16_t datasize)
{
...
void QunpUCXX14::deal_upgrade_ack(uint8_t *buffer, uint16_t datasize)
{
    Q_UNUSED(datasize)
...
void QunpUCXX14::deal_read_param(uint8_t *data, uint16_t len)
{
    Q_UNUSED(len)
...
void QunpUCXX14::deal_read_param_ack(uint8_t *data, uint16_t len)
{
...
void QunpUCXX14::deal_write_param(uint8_t *data, uint16_t len)
{
...
void QunpUCXX14::deal_write_param_ack(uint8_t *data, uint16_t len)
{
    Q_UNUSED(len)
...
void QunpUCXX14::unp_delay(uint32_t ms)
{
#ifdef USE_IN_STM32
    HAL_Delay(ms);
#else
...
unp_state_t QunpUCXX14::wait_for_ack(void)
{
...
uint8_t QunpUCXX14::unp_verify(void)
{
    uint8_t ret = 1;
...
uint16_t QunpUCXX14::generate_pkt(uint8_t *data, uint16_t datasize, uint8_t *pkt, unp_pack_t type)
{
    uint16_t offset = 4;
...
uint8_t QunpUCXX14::unp_frame_split(uint8_t *data, uint16_t datasize, uint16_t *pos, uint16_t *len)
{
    uint8_t num = 0;
    uint8_t cnt = 0;
    uint16_t i;
...
void QunpUCXX14::unp_send_pkt(uint8_t *data, uint16_t pktsize)
{
    if(g_comnct_type == COMNCT_NFC)
    {
...
uint16_t QunpUCXX14::read_device_params(uint8_t *params, uint8_t *data)
{
    uint16_t datasize = 0;
...
unp_state_t QunpUCXX14::send_read_param_request(uint8_t *out, uint8_t *in, uint16_t insize)
{
    uint8_t pkt[UNP_MAX_PKTSIZE] = {0};
    uint16_t pktsize = 0;
...
unp_state_t QunpUCXX14::send_write_param_request(uint8_t *data, uint16_t datasize)
{
    uint8_t pkt[UNP_MAX_PKTSIZE] = {0};
    uint16_t pktsize = 0;
...
unp_state_t QunpUCXX14::write_device_params(uint8_t *data, uint16_t datasize)
{
...
void QunpUCXX14::get_device_passwd(uint8_t *data)
{
    Q_UNUSED(data)
    read_data_from_flash((uint32_t *)data, UNP_PASSWD_LEN, (uint32_t)pDeviceParam->password, 0);
}

void QunpUCXX14::get_device_appkey(uint8_t *data)
{
    read_data_from_flash((uint32_t *)data, 16, (uint32_t)pLoRaWANParams->AppKey, 0);
}

void QunpUCXX14::get_productid(uint8_t *data)
{
    read_data_from_flash((uint32_t *)data, UNP_PRODUCT_ID_LEN, (uint32_t)pProductInfo->productid, 0);
}

void QunpUCXX14::get_device_hwver(uint8_t *data)
{
    read_data_from_flash((uint32_t *)data, UNP_HWVER_LEN, (uint32_t)pProductInfo->hwver, 0);
}
void QunpUCXX14::set_device_swver(uint8_t *data)
{
    write_data_to_flash((uint32_t *)data, strlen((const char *)data), (uint32_t)pProductInfo->swver);
}

void QunpUCXX14::set_upgrade_enable_flag(uint8_t upgrade_enable)
{
    write_data_to_flash((uint32_t *)&upgrade_enable, 1, (uint32_t)&pFlash_flag->upgrade_enable);
}

void QunpUCXX14::set_upgrade_flag(uint8_t *buf)
{
...
void QunpUCXX14::get_device_real_pn(uint8_t *data)
{
    uint8_t offset = 0;
    uint8_t len = 0;
    uint8_t tmp[UNP_PN_TOTAL_LEN];
...
void QunpUCXX14::get_device_pn(uint8_t *data)
{
    uint8_t offset = 0;
    uint8_t len = 0;
    uint8_t i;
...
void QunpUCXX14::get_device_oem(uint8_t *data)
{
    uint8_t offset = 0;
    uint8_t len = 0;
...
void QunpUCXX14::get_device_custom(uint16_t *value)
{
...
void QunpUCXX14::get_device_sn(uint8_t *data)
{
    read_data_from_flash((uint32_t *)data, UNP_PRODUCT_SN_LEN, (uint32_t)pProductInfo->productsn, 0);
}

void QunpUCXX14::write_data_to_flash(uint32_t *data, uint16_t len_bytes, uint32_t addr)
{
    memcpy((void *)addr, data, len_bytes);
}

void QunpUCXX14::read_data_from_flash(uint32_t *data, uint16_t len_bytes, uint32_t addr, uint8_t fromisr)
{
    Q_UNUSED(fromisr)
    memcpy(data, (void *)addr, len_bytes);
}

void QunpUCXX14::unxx_reset_device(void)
{

}
void QunpUCXX14::unxx_restart_device(void)
{

}

void QunpUCXX14::unp_set_ussd_ack(uint8_t *data, uint16_t datasize)
{
    Q_UNUSED(data)
    Q_UNUSED(datasize)
}

void QunpUCXX14::get_upgrade_info(uint8_t *flag, uint32_t *crc32, uint32_t *size)
{
    Q_UNUSED(flag)
    Q_UNUSED(size)
    Q_UNUSED(crc32)
...
void QunpUCXX14::set_upgrade_info(uint8_t flag, uint32_t crc32, uint32_t size)
{
    Q_UNUSED(flag)
    Q_UNUSED(size)
    Q_UNUSED(crc32)
...
int QunpUCXX14::deal_with_unp(uint8_t *data, uint32_t len, unp_comnct_t type)
{
    Q_UNUSED(type)
    unp_state_t ret = UNP_SUCCESS;
    uint8_t pkt_type;
...
/**
 * 串口初始化
 * @brief QunpUCXX14::initSerialPort
 * @param s
 * @return
 */
bool QunpUCXX14::initSerialPort(SerialInfo s)
{
...
void QunpUCXX14::read_serialport_data()
{
    if(m_port->isOpen() && m_ackFlag){
...
/**
 * 主动关闭串口
 * @brief QunpUCXX14::close_serialport
 */
void QunpUCXX14::close_serialport()
{
    if(m_port->isOpen()){
        m_port->close();
    }
...
bool QunpUCXX14::reopen_serialport()
{
    if(m_port->isOpen()){
        return true;
    }
...
void QunpUCXX14::set_comnct_type(unp_comnct_t g_comnct_type_tmp)
{
    g_comnct_type = g_comnct_type_tmp;
}

int QunpUCXX14::unp_send_passwd(uint8_t *passwd, uint16_t len)
{
    uint8_t pkt[64] = {0};
    uint16_t pktsize = 0;
    m_ackFlag = true;
...
unp_state_t QunpUCXX14::unp_get_version(uint8_t *version)
{
    unp_state_t ret;
...
int QunpUCXX14::unp_get_product_name(uint8_t *name)
{
    unp_state_t ret;
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
...
int QunpUCXX14::unp_get_product_pn(uint8_t *pn)
{
    unp_state_t ret;
    uint8_t buf[32] = {0};
    uint8_t out[32] = {0};
...
unp_state_t QunpUCXX14::unp_set_passwd(uint8_t *old_passwd, uint8_t *new_passwd)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_product_hwver(uint8_t *hwver)
{
    unp_state_t ret;
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_product_swver(uint8_t *swver)
{
    unp_state_t ret;
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_product_sn(uint8_t *sn)
{
    unp_state_t ret;
...
unp_state_t QunpUCXX14::unp_get_oem(uint8_t *oem)
{
    unp_state_t ret;
...
unp_state_t QunpUCXX14::unp_get_product_real_pn(uint8_t *pn)
{
    unp_state_t ret;
    uint8_t buf[32] = {0};
    uint8_t out[32] = {0};
...
unp_state_t QunpUCXX14::unp_get_lora_status(uint32_t dataoffset, uint32_t datasize, uint8_t *out)
{
    unp_state_t ret;
...
unp_state_t QunpUCXX14::unp_get_lora(uint32_t dataoffset, uint32_t datasize, uint8_t *out)
{
    uint8_t offset = 8;
    uint8_t pkt[UNP_MAX_PKTSIZE] = {0};
    uint16_t pktsize = 8;
...
unp_state_t QunpUCXX14::unp_set_lora(uint8_t value, uint8_t valueoffset)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint32_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_lora(uint8_t *value, uint8_t valueoffset, uint16_t datasize)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint32_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_lora(uint32_t value, uint8_t valueoffset, uint16_t datasize)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint32_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_device_status(device_status_t *status)
{
    unp_state_t ret;
...
unp_state_t QunpUCXX14::unp_get_device_time(uint32_t *timestamp, int16_t *timezone)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_sensor_data(sensor_status_em *temphumi)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[256] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_collect_cycle(uint32_t cycle)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_collect_cycle(uint32_t *cycle)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_cloud_cycle(uint32_t *cycle)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_cloud_cycle(uint32_t cycle)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_sensor_cfg(user_config_t *sensors_cfg)
{
    unp_state_t ret;
...
unp_state_t QunpUCXX14::unp_set_sensor_cfg(user_config_t *sensors_cfg)
{
    uint8_t buf[256] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_abnormal_set(abnormal_check_set_t * abnormal, abnormal_check_patch_set_t *abnormal_patch)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[256] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_abnormal_set(abnormal_check_set_t * abnormal, abnormal_check_patch_set_t *abnormal_patch)
{
    uint8_t buf[256] = {0};
    uint8_t offset = 0;
    uint8_t *pdata;
...
unp_state_t QunpUCXX14::unp_get_alarm(uint8_t num, alarm_rules_t *alarmconfig)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[256] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_alarm(uint8_t num, alarm_rules_t *alarmconfig)
{
    uint8_t buf[256] = {0};
    uint8_t offset = 0;
    uint8_t *pdata;
...
unp_state_t QunpUCXX14::unp_send_upgrade_request(void)
{
    unp_state_t ret;
    uint8_t pkt[64] = {0};
    uint16_t pktsize = 0;
...
unp_state_t QunpUCXX14::unp_connect_device(void)
{
    uint8_t pkt[UNP_MAX_PKTSIZE] = {0};
    uint16_t pktsize = 0;
...
/**
 * @brief QunpUCXX14::unp_upgrade_check
 * @param crc32
 * @param productid
 * @param hwver
 * @param swver
 ...
 * @return
 */
unp_state_t QunpUCXX14::unp_upgrade_check(uint32_t crc32, uint8_t *productid, uint8_t *hwver, uint8_t *swver, uint8_t *pn,int imageVer)
{
//    QThread::msleep(3000);
...
unp_state_t QunpUCXX14::unp_send_upgrade_image(uint8_t *data, uint32_t datasize)
{
...
unp_state_t QunpUCXX14::unp_upgrade_complete(void)
{
    uint8_t pkt[UNP_MAX_PKTSIZE] = {0};
    uint16_t pktsize = 0;
...
unp_state_t QunpUCXX14::unp_reset_device()
{
    uint8_t pkt[UNP_MAX_PKTSIZE] = {0};
    uint16_t pktsize = 0;
...
unp_state_t QunpUCXX14::unp_send_reboot_request(void)
{
    qInfo()<<"#################"<<"reboot ing";
    uint8_t pkt[64] = {0};
    uint16_t pktsize = 0;
...
unp_state_t QunpUCXX14::unp_set_lora_reload_config()
{
    qInfo()<<"#################"<<"reload lora";
    uint8_t pkt[64] = {0};
    uint16_t pktsize = 0;
...
unp_state_t QunpUCXX14::unp_set_product_pn(uint8_t *pn)
{
     uint8_t buf[32] = {0};
     uint8_t offset = 0;
     uint8_t len;
...
unp_state_t QunpUCXX14::unp_get_uc11t1_data(uc11t1_temphumi_t *temphumi)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[256] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_enable_auto_report(uint8_t state)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
    uint16_t threshold;
...
unp_state_t QunpUCXX14::unp_get_enable_auto_report(uint8_t *state)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_uc11t1_alarm(uint8_t num, alarm_rules_t *alarmconfig)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[256] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_uc11t1_alarm(uint8_t num, alarm_rules_t *alarmconfig)
{
    uint8_t buf[256] = {0};
    uint8_t offset = 0;
    uint8_t *pdata;
...
unp_state_t QunpUCXX14::unp_set_temp_humi_compensate(uint8_t temp_enable, int16_t temp_value, uint8_t humi_enable, int16_t humi_value)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_temp_humi_compensate(uint8_t *temp_enable, int16_t *temp_value, uint8_t *humi_enable, int16_t *humi_value)
{
    unp_state_t ret;
...
unp_state_t QunpUCXX14::unp_get_mobile_state(unp_mobile_state_t *state)
{
    unp_state_t ret;
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t out[UNP_MAX_PKTSIZE] = {0};
...
unp_state_t QunpUCXX14::unp_get_mobile_signal(uint8_t *signal)
{
    unp_state_t ret;
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t out[UNP_MAX_PKTSIZE] = {0};
...
unp_state_t QunpUCXX14::unp_get_inputio_status(uint8_t gpionum, uint8_t *value)
{
    unp_state_t ret;
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t out[UNP_MAX_PKTSIZE] = {0};
...
unp_state_t QunpUCXX14::unp_get_outputio_status(uint8_t gpionum, uint8_t *value)
{
    unp_state_t ret;
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t out[UNP_MAX_PKTSIZE] = {0};
...
unp_state_t QunpUCXX14::unp_set_current_time(unxxtime_t *cur)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_current_time(unxxtime_t *cur)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_app_mode(app_mode_t mode)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_app_mode(app_mode_t *mode)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[64] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_mqtt_keepalive(uint32_t keepalive)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_mqtt_keepalive(uint32_t *keepalive)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_mobile_apn(uint8_t *apn)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_mobile_apn(uint8_t *apn, uint8_t *username, uint8_t *password)
{
    unp_state_t ret;
...
unp_state_t QunpUCXX14::unp_set_mobile_apn(uint8_t *apn, uint8_t *username, uint8_t *password)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_update_rootcrt(uint8_t *data, uint16_t datasize)
{
    uint8_t num;
    uint8_t loop;
    uint16_t pos;
...
unp_state_t QunpUCXX14::unp_get_rootcrt(uint8_t *data, uint16_t datasize)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[256] = {0};
    uint8_t num = 0;
...
unp_state_t QunpUCXX14::unp_set_update_devcrt(uint8_t *data, uint16_t datasize)
{
    uint8_t num;
    uint8_t loop;
    uint16_t pos;
...
unp_state_t QunpUCXX14::unp_get_devcrt(uint8_t *data, uint16_t datasize)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[256] = {0};
    uint8_t num = 0;
...
unp_state_t QunpUCXX14::unp_set_update_prikey(uint8_t *data, uint16_t datasize)
{
    uint8_t num;
    uint8_t loop;
    uint16_t pos;
...
unp_state_t QunpUCXX14::unp_get_prikey(uint8_t *data, uint16_t datasize)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[256] = {0};
    uint8_t num = 0;
...
unp_state_t QunpUCXX14::unp_set_endpoint_name(uint8_t *name)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_endpoint_name(uint8_t *name)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[256] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_endpoint_addr(uint8_t *addr)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_endpoint_addr(uint8_t *addr)
{
    unp_state_t ret;
...
unp_state_t QunpUCXX14::unp_get_device_desc(uint8_t *desc)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_device_desc(uint8_t *desc)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
    uint8_t datasize = 0;
...
unp_state_t QunpUCXX14::unp_set_tcpudp_config(app_tcpudp_t *tcpudp_set)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint16_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_tcpudp_config(app_tcpudp_t *tcpudp_set)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[UNP_MAX_PKTSIZE] = {0};
    uint16_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_mqtt_config(app_mqtt_t *mqtt_set)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint32_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_mqtt_config(app_mqtt_t *mqtt_set)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_onenet_config(unxx_onenet_setting_t *onenet_set)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_onenet_config(unxx_onenet_setting_t *onenet_get)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_ali_cfg(unxx_ali_setting_t *ali_cfg)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_ali_cfg(unxx_ali_setting_t *ali_cfg)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_cellular_net_type(cellular_network_t value)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_cellular_net_type(cellular_network_t *value)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[64] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_cellular_sca(uint8_t *sca)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_cellular_sca(uint8_t *sca)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[64] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_cellular_pin(uint8_t *pin)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_cellular_pin(uint8_t *pin)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[64] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_sms_dcs(sms_dcs_t code)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_sms_dcs(sms_dcs_t *code)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[64] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_tcpudp_status(uint8_t *state)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_osh(uint8_t num, float osh)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_osh(uint8_t num, float *osh)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_set_osl(uint8_t num, float osl)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_osl(uint8_t num, float *osl)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_ai_value(uint8_t num, float *current, float *usrdata)
{
    unp_state_t ret;
    uint8_t buf[8] = {0}, out[32] = {0};
    uint8_t offset = 0;
...
unp_state_t QunpUCXX14::unp_get_11xx_gpio_counter(uint8_t gpionum, uint8_t *mode, uint8_t *start, uint32_t *value)
{
    unp_state_t ret;
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t out[UNP_MAX_PKTSIZE] = {0};
...
unp_state_t QunpUCXX14::unp_get_gpio_counter(uint8_t gpionum, uint32_t *value, uint8_t *start)
{
    unp_state_t ret;
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t out[UNP_MAX_PKTSIZE] = {0};
...
unp_state_t QunpUCXX14::unp_set_gpio_counter(uint8_t gpionum, uint32_t value)
{
    uint8_t buf[UNP_MAX_PKTSIZE] = {0};
    uint8_t offset = 0;
