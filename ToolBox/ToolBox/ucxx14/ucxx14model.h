#ifndef UCXX14MODEL_H
#define UCXX14MODEL_H
...
class UCXX14Model : public MyWindowStytle
{
    Q_OBJECT
...
public:
    ...
    explicit UCXX14Model(QWidget *parent = nullptr);
    ~UCXX14Model();
...
public slots:
    ...
    void onRecvDeviceStatus(UCXX14DealThread::StructPageStatus);
    void onRecvGeneral(UCXX14DealThread::StructPageGeneral info);
...
private slots:
    ...
    void on_gpioType2_cbx_currentIndexChanged(int index);
    void on_gpioCounterStart_btn_clicked();
    void on_gpioCounterRefresh_btn_clicked();
    void on_gpioCounterClear_btn_clicked();
    void on_gpioCounterStart2_btn_clicked();
    void on_gpioCounterRefresh2_btn_clicked();
    void on_gpioCounterClear2_btn_clicked();
...
private:
    ...
    UCXX14DealThread *m_dealThread;
    QThread *m_thread;

    UCXX14DealThread::StructPageStatus m_statusPageInfo;
    UCXX14DealThread::StructPageGeneral m_generalPageInfo;
    UCXX14DealThread::StructPageSetting m_settingPageInfo;
